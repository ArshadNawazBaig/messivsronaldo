...
<body class="rivalry-status-standalone"><header class="rivalry-status-header"><a href="/" aria-label="The Rivalry home"><svg viewBox="0 0 30 38" aria-hidden="true"><path fill="currentColor" d="M8 7h6L6 31H0zm9-7h6L11 38H5zm7 7h6l-8 24h-6z"/></svg>THE RIVALRY</a></header>
