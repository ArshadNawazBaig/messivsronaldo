export const policyUpdated = "2026-09-21";
export const policyUpdatedLabel = "21 September 2026";
...
export const policies: Record<string, Policy> = {
  terms: {
    ...
    description: "The terms for using our comparisons, articles and downloads on messivsronaldo17.com.",
    sections: [
  ...
  privacy: {
    ...
    sections: [
      ...
      { id: "browser-storage", title: "Preferences and browser storage", paragraphs: ["Your light or dark theme choice is saved in your browser as rivalry-theme. It stays there until you change it, clear site data or your browser removes it. Comparison filters are stored in the URL fragment so that a comparison can be restored or shared.", "Site search matches page titles locally in your browser. We do not send the search text to a search provider. Fonts and player photographs are served with the website; there are no Getty image embeds in this edition."], links: [{ href: "/cookies", label: "Cookies and local storage" }] },
      { id: "contact-and-corrections", title: "Contact and correction reports", paragraphs: ["Correction reports are prepared and downloaded in your browser. Downloading a report does not submit it to a server. When an email contact is available and you choose to send a message, your email provider handles delivery.", "A message you send may include your email address, the issue you describe and any details you choose to provide. Those details are used to respond to the request and investigate the issue. Avoid including sensitive information or details about other people that are not needed."], links: [{ href: "/contact", label: "Contact and corrections" }] },
  ...
  cookies: {
    ...
    sections: [
      ...
      { id: "other-features", title: "Search, filters and third parties", paragraphs: ["Search runs locally. Comparison filters can appear after the # symbol in a shared URL; those fragments are not sent as part of an HTTP request to the server. A downloaded correction report does not create a tracking cookie.", "This edition does not set advertising or analytics cookies and does not load third-party photo embeds. External websites may use their own cookies after you follow a link to them."] },
