...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const routes = ["", "/updates", "/compare", "/goals", "/champions-league", "/la-liga", "/international", "/honours", "/assists", "/methodology", "/about", "/credits", "/contact", "/privacy", "/insights", "/players/messi", "/players/ronaldo", ...articles.map(a => `/insights/${a.slug}`)];
