...
export function CalendarExplorer({ selected = "all" }: {
    ...
    function download() {
        ...
        a.href = url;
        a.download = `the-rivalry-calendar-${selected}-${snapshotDate}.csv`;
        a.click();
